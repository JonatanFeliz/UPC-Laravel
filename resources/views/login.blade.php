            ...
            <div class="col-6" style="background-color: #0E131F">
                <form class="row g-3 p-5">
                    ...
                    <div class="col-md-12 form-floating">
                      <input type="text" class="form-control rounded-pill" id="user" placeholder="> Usuario" style="background-color: #0E131F; border-color:#5EE4A3">
                      <label for="user" style="color: #5EE4A3">> Usuario</label>
                    </div>
                    <div class="col-md-12 form-floating">
                      <input type="text" class="form-control rounded-pill" id="password" placeholder="> Contraseña" style="background-color: #0E131F; border-color:#5EE4A3">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <button class="btn text-white w-25 rounded-0" style="background-color: #5EE4A3">Entrar</button>
                    </div>
